...
import LogoImg from '../images/logo/osm_mobile_logo.png'
    ...
    <div>
        <StyledNav 
            ...
            <NavLinks>
                ...
                <Link href='/osm-resources' variants={item}>Resources</Link>
                <Link href='/osm-blog' variants={item}>Blog</Link>
                <Link href='/osm-jobs' variants={item}>Travel Jobs</Link>
            </NavLinks>
